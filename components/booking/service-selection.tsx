...
import { services, formatCurrency, getServiceById, type Service } from "@/lib/dummy-data"
...
export function ServiceSelection({
  ...
  useEffect(() => {
    if (preselectedServiceId && !selected) {
      const service = getServiceById(preselectedServiceId)
      if (service) {
        setSelected(service)
        onServiceSelect(service)
      }
    }
  }, [preselectedServiceId, selected, onServiceSelect])
