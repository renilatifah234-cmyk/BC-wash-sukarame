...
>(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, ref) => {
  ...
  // openProp/setOpenProp untuk kontrol dari luar
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // simpan state sidebar di cookie
  ...
  // tambah shortcut keyboard untuk toggle
  React.useEffect(() => {
  ...
  // buat state agar bisa pakai data-state="expanded" atau "collapsed"
  // memudahkan styling Tailwind
    ...
    >
      ...
      <div
        className={cn(
          ...
          // sesuaikan padding untuk variant floating/inset
          variant === "floating" || variant === "inset"
    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          // perbesar area tombol di mobile
